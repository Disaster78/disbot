...
async def sendwebhook(
    ...
    id: str = SlashOption(required=True, description="Note: If you want to specify a separate username and avatar for the webhook embed, you have to use the username and avatarurl option, other wise set the send_subsequent option to true."),
